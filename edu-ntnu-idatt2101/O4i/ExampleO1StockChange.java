...
public class ExampleO1StockChange {
   ...
   */
  public ExampleO1StockChange(List<Integer> listOfStockChanges) {
  ...
  public static void findBestProfitTimer(List<Integer> listOfNumbers) {
    ExampleO1StockChange stockChange = new ExampleO1StockChange();
